...
#define PID_THRESHOLD 1100                                //the limit at which to start the PID control loop

#define MAX_TOTAL_THRUST 1800
#define MAX_CONTROLLER_THRUST 1350                        // The maximum value the controller can set the base thrust
#define TAKEOFF_THRUST 1275                               // Temp variable, this is the full throttle with left stick all the way forward
...
//	Serial.print("\t");
  ...
  joystickToBaseThrust();
	...
	if (MOTOR_FL_BASE < PID_THRESHOLD){
		MOTOR_FL_BAL = 0;
		MOTOR_FR_BAL = 0;
		MOTOR_BL_BAL = 0;
		MOTOR_BR_BAL = 0;   

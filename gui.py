...
class GUI():
	def __init__(self, serial):
		...
		self.l = Label(self.master, text="Roll Pval")
                ...
                self.sb = Spinbox(self.master, from_=0.0, to=10.0, format="%.2f", increment=0.01)
